...
<div class="card mb-5">
    <div class="card-body">
        ...
        <div class="chart-container <?= $data->total['removed_background_images'] ? null : 'd-none' ?>">
            <canvas id="removed_background_images"></canvas>
        </div>
        <?= $data->total['removed_background_images'] ? null : include_view(THEME_PATH . 'views/partials/no_chart_data.php', ['has_wrapper' => false]); ?>
    </div>
</div>
...
<script>
    ...
    /* Display chart */
    let removed_background_images_chart = document.getElementById('removed_background_images').getContext('2d');
