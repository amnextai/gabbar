...
<div class="card mb-5">
    <div class="card-body">
        ...
        <div class="chart-container <?= $data->total['upscaled_images'] ? null : 'd-none' ?>">
            <canvas id="upscaled_images"></canvas>
        </div>
        <?= $data->total['upscaled_images'] ? null : include_view(THEME_PATH . 'views/partials/no_chart_data.php', ['has_wrapper' => false]); ?>
    </div>
</div>
...
<script>
    ...
    /* Display chart */
    let upscaled_images_chart = document.getElementById('upscaled_images').getContext('2d');
