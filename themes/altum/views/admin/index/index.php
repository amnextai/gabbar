    ...
    <div class="col-12 col-sm-6 col-xl-3 p-3 position-relative">
        <div class="card d-flex flex-row h-100 overflow-hidden">
            ...
            <div class="card-body text-truncate">
                <small class="text-muted font-weight-bold"><?= l('admin_documents.menu') ?></small>
                <div class="mt-2"><span class="h4"><?= nr($data->documents) ?></span></div>
                <div class="mt-1"><span class="small text-muted"><?= nr($data->documents_current_month) ?> <?= mb_strtolower(l('global.date.this_month')) ?></span></div>
            </div>

            <div class="p-4 mt-1">
                <a href="<?= url('admin/documents') ?>" class="stretched-link">
                <span class="p-2 bg-primary-100 rounded">
                    <i class="fas fa-fw fa-robot text-primary"></i>
                </span>
                </a>
            </div>
        </div>
    ...
    <div class="col-12 col-sm-6 col-xl-3 p-3 position-relative">
        <div class="card d-flex flex-row h-100 overflow-hidden">
            <div class="card-body text-truncate">
                ...
                <div class="mt-2"><span class="h4"><?= nr($data->images) ?></span></div>
                <div class="mt-1"><span class="small text-muted"><?= nr($data->images_current_month) ?> <?= mb_strtolower(l('global.date.this_month')) ?></span></div>
            </div>

            <div class="p-4 mt-1">
                <a href="<?= url('admin/images') ?>" class="stretched-link">
                    <span class="p-2 bg-primary-100 rounded">
                        <i class="fas fa-fw fa-icons text-primary"></i>
                    </span>
                </a>
            </div>
        </div>
    ...
    <div class="col-12 col-sm-6 col-xl-3 p-3 position-relative">
        <div class="card d-flex flex-row h-100 overflow-hidden">
            <div class="card-body text-truncate">
                ...
                <div class="mt-2"><span class="h4"><?= nr($data->transcriptions) ?></span></div>
                <div class="mt-1"><span class="small text-muted"><?= nr($data->transcriptions_current_month) ?> <?= mb_strtolower(l('global.date.this_month')) ?></span></div>
            </div>

            <div class="p-4 mt-1">
                <a href="<?= url('admin/transcriptions') ?>" class="stretched-link">
                    <span class="p-2 bg-primary-100 rounded">
                        <i class="fas fa-fw fa-microphone-alt text-primary"></i>
                    </span>
                </a>
            </div>
        </div>
    ...
    <div class="col-12 col-sm-6 col-xl-3 p-3 position-relative">
        <div class="card d-flex flex-row h-100 overflow-hidden">
            <div class="card-body text-truncate">
                ...
                <div class="mt-2"><span class="h4"><?= nr($data->chats) ?></span></div>
                <div class="mt-1"><span class="small text-muted"><?= nr($data->chats_current_month) ?> <?= mb_strtolower(l('global.date.this_month')) ?></span></div>
            </div>
    ...
    <div class="col-12 col-sm-6 col-xl-3 p-3 position-relative">
        <div class="card d-flex flex-row h-100 overflow-hidden">
            <div class="card-body text-truncate">
                ...
                <div class="mt-2"><span class="h4"><?= nr($data->projects) ?></span></div>
                <div class="mt-1"><span class="small text-muted"><?= nr($data->projects_current_month) ?> <?= mb_strtolower(l('global.date.this_month')) ?></span></div>
            </div>
