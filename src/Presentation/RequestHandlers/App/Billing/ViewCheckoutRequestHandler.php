    ...
    public function handle(ServerRequestInterface $request): ResponseInterface
    {
        ...
        foreach ($this->factory as $key => $gateway) {
            ...
            if ($gateway instanceof OffsitePaymentGatewayInterface) {
                $supportsPlanMethod = [$gateway, 'supportsPlan'];
                if (is_callable($supportsPlanMethod) && !$supportsPlanMethod($plan)) {
                    continue;
                }
            ...
            if ($gateway instanceof OfflinePaymentGatewayInterface && $gateway->supportsPlan($plan)) {
