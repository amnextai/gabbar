                ...
                <div class="card">
                    <div class="card-body">
                        ...
                        <section id="requirements" style="display: none">
                            ...
                            <div class="table-responsive table-custom-container mt-5">
                                <table class="table table-custom">
                                    ...
                                    <tbody>
                                    <?php foreach(['config.php', 'uploads/main/', 'uploads/cache/', 'uploads/offline_payment_proofs/', 'uploads/blog/', 'uploads/pwa/', 'uploads/images/', 'uploads/syntheses/', 'uploads/chats_assistants/', 'uploads/chats_images', 'uploads/upscaled_images/', 'uploads/removed_background_images/', 'uploads/replaced_background_images/'] as $key): ?>
                                    <tr>
                                        <td>/<?= $key ?></td>
                        ...
                        <section id="finish" style="display: none">
                            ...
                            <div class="alert alert-success">The installation process has been successfuly completed!</div> <a style="color:red;" href="https://weadown.com" target="_blank">weadown.com</a>
